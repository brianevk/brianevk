...
### 🛠️ Core Stack & Expertise: The Tools I Build With

Over the past three years of academic study and self-learning, I have acquired a versatile and specialized skillset:
...
### ✨ Featured Projects: Where Code Meets Creativity 🚀

These projects demonstrate my technical depth and ability to execute across diverse technologies, especially in high-fidelity Front-End and specialized Mobile fields.

#### 1. Weldin: AR Welding Learning Application
* A specialized AR mobile app providing a safe and realistic virtual welding practice environment.
* *Interested in AR development? [Check out the Weldin Repo!](https://github.com/brianevk/Weldin)*

#### 2. Christian Wijaya: Responsive E-Commerce Site
* *See the code quality firsthand. [View the E-Commerce Repo!](https://github.com/brianevk/ChristianWijaya)*

#### 3. DoJo Movie: Mobile E-Ticketing & Mapping
* A functional Kotlin-based mobile app featuring secure authentication and Google Maps integration.
* *Explore the Mobile App. [View the Dojo Movie Repo!](https://github.com/Raihan260/Dojo_Movie)*

---

### 💡 Organization & Leadership Experience 🌐

My passion extends beyond code; I excel at managing complex projects and coordinating large teams:

| Role | Organization | Focus |
| :--- | :--- | :--- |
| **Project Manager – TECHNO 2025** | HIMTI BINUS University | Directed multi-regional operations, **managed 190+ committee members**. |
| **Senior Academic Course Mentor** | BINUS University | Provided academic guidance in **HCI** and foundational technical subjects. |

> For a complete timeline, detailed responsibilities, and academic achievements, **Please check my CV for further details!**

---

### 📬 Let's Connect! I'm Always Open to New Challenges 🚀

I'm keen on exploring roles in **Mobile Engineering**, or **Full-Stack/Front-End** projects. I'm actively seeking opportunities to apply my unique blend of skills.
